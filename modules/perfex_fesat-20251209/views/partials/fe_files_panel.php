    ...
    <div class="panel-body">
        ...
        <?php if (empty($document)) { ?>
            ...
            <?php if (staff_can('generate', 'fe_sat') && isset($invoice->id)) { ?>
                <a href="<?= admin_url('perfex_fesat/form/' . $invoice->id); ?>" class="btn btn-primary mtop10"><?= _l('fe_sat_generate_invoice_action'); ?></a>
            <?php } ?>
        <?php } else { ?>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6 text-right">
                    <?php if ($document->status === 'success') { ?>
                        ...
                        <?php if ($showPdf) { ?>
                            <a target="_blank"
                               href="<?= $hasPdf ? admin_url('perfex_fesat/view-file/' . $document->id . '/pdf') : base_url('media/90DCC64C-D2BF-4A63-A97D-5543208E5E10.pdf'); ?>"
                        ...
                        <?php if ($showXml) { ?>
                            <a target="_blank"
                               href="<?= $hasXml ? admin_url('perfex_fesat/view-file/' . $document->id . '/xml') : base_url('media/90DCC64C-D2BF-4A63-A97D-5543208E5E10.xml'); ?>"
                               class="btn btn-default">
