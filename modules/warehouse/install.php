...
// FIX: Added purchase_price column to inventory_manage table
// This column was missing, causing "Unknown column 'purchase_price'" error during Excel import
// The add_inventory_manage() function uses this column to track inventory by purchase price (for FIFO/LIFO accounting)
// Migration from: modules/warehouse/migrations/127_version_127.php
if (!$CI->db->field_exists('purchase_price', 'inventory_manage')) {
    $CI->db->query('ALTER TABLE `'.db_prefix() . 'inventory_manage`
