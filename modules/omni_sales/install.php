...
add_option('records_time1', date('Y-m-d H:i:s'));
add_option('records_time2', date('Y-m-d H:i:s'));
add_option('records_time3', date('Y-m-d H:i:s'));
add_option('records_time4', date('Y-m-d H:i:s'));
add_option('records_time5', date('Y-m-d H:i:s'));
add_option('records_time6', date('Y-m-d H:i:s'));
add_option('records_time7', date('Y-m-d H:i:s'));
add_option('records_time8', date('Y-m-d H:i:s'));
