                        ...
                        <?php else : ?>
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="delivery-sheet-table">
                                    ...
                                    <tbody>
                                        <?php foreach ($delivery_sheet as $stop) : ?>
        ...
        function buildDeliverySheetText() {
            ...
            $deliverySheetTable.find('tbody tr').each(function() {
                ...
                if ($cells.length === 6) {
                    ...
                    var orderNumber = $cells.eq(1).text().trim();
                    var customer = $cells.eq(2).text().trim();
                    var product = $cells.eq(3).text().trim();
                    var quantity = $cells.eq(4).text().trim();
                    var unit = $cells.eq(5).text().trim();
