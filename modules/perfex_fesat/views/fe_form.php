            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?= form_open(admin_url('fe_sat/generate/' . $invoice->id), ['id' => 'fe-sat-generate']); ?>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="text" class="form-control" name="currency" id="currency"
                                       ...
                                       maxlength="3" pattern="[A-Z]{3}" title="3-letter currency code (e.g., MXN, USD)">
                                <small class="text-muted">Use 3-letter code: MXN, USD, etc.</small>
                            </div>
                        </div>
