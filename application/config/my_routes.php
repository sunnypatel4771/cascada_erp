...
/**
 * Custom routes for Ramos module client portal
 * This file is included by application/config/routes.php
 */

// Route client portal ramos module requests
$route['clients/ramos_client/(:any)'] = 'ramos/ramos_client/$1';
$route['clients/ramos_client'] = 'ramos/ramos_client';

/**
 * FE-SAT Module Routes (CFDI 4.0 Invoicing)
 */
