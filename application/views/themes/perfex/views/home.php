...
<div class="row">
    ...
    <script>
        ...
        function createOrderRow(description, unit, qty, rate, longDescription = '', imageUrl = '', maduracion = '', hasMaduracion = null) {
            ...
            // Determine if maduración cell should be visible
            const maduracionDisplay = productHasMaduracion ? '' : 'display: none;';
            ...
            row.innerHTML = `
                ...
                <td class="maduracion-cell" id="maduracion-cell-${orderItemsCounter}" style="${maduracionDisplay}">
        ...
        // Show/hide maduración dropdown and manage required attribute
        function updateMaduracionVisibility(counter, show) {
            ...
            if (maduracionCell && maduracionSelect) {
                if (show) {
                    maduracionCell.style.display = '';
                    maduracionSelect.setAttribute('required', 'required');
                } else {
                    maduracionCell.style.display = 'none';
                    maduracionSelect.removeAttribute('required');
                    maduracionSelect.value = ''; // Clear selection when hidden
                }
            }
        }
