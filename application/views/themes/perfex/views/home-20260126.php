...
<div class="row">
                    ...
                    <div class="panel-body">
                        <?php if (isset($latest_order) && $latest_order && !empty($latest_order_items)): ?>
                            <table class="table table-bordered table-striped">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="5" class="text-right"><?php echo _l('subtotal'); ?>:</td>
                                        <td class="text-right"><?php echo $currency_symbol . number_format($previous_order_total, 2); ?></td>
                                    </tr>
                                    <?php if ($customer_discount_percent > 0): ?>
                                    <tr class="text-success">
                                        <td colspan="5" class="text-right"><?php echo _l('discount'); ?> (<?php echo $customer_discount_percent; ?>%):</td>
                                        <td class="text-right">-<?php echo $currency_symbol . number_format($previous_order_discount_amount, 2); ?></td>
                                    </tr>
                                    <?php endif; ?>
                                    <tr class="active">
                                        <td colspan="5" class="text-right"><strong><?php echo _l('order_total'); ?>:</strong></td>
                                        <td class="text-right"><strong><?php echo $currency_symbol . number_format($previous_order_total_after_discount, 2); ?></strong></td>
                                    </tr>
                                </tfoot>
                            </table>
                        <?php else: ?>
                            ...
                            <div class="row mtop15">
                                <div class="col-md-12">
                                    <table class="table table-condensed pull-right" style="width: auto;">
                                        <tr>
                                            <td class="text-right"><?php echo _l('subtotal'); ?>:</td>
                                            <td class="text-right" style="min-width: 100px;"><?php echo $currency_symbol; ?><span id="order-subtotal">0.00</span></td>
                                        </tr>
                                        <?php if ($customer_discount_percent > 0): ?>
                                        <tr class="text-success">
                                            <td class="text-right"><?php echo _l('discount'); ?> (<?php echo $customer_discount_percent; ?>%):</td>
                                            <td class="text-right">-<?php echo $currency_symbol; ?><span id="order-discount">0.00</span></td>
                                        </tr>
                                        <?php endif; ?>
                                        <tr class="active">
                                            <td class="text-right"><strong><?php echo _l('order_total'); ?>:</strong></td>
                                            <td class="text-right"><strong><?php echo $currency_symbol; ?><span id="order-total">0.00</span></strong></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
    ...
    <script>
        ...
        const customerDiscountPercent = <?php echo $customer_discount_percent; ?>;
