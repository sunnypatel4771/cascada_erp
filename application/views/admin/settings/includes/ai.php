...
<div class="com-md-12">
    <?php echo render_select('settings[ai_provider]', \app\services\ai\AiProviderRegistry::getAllProviders(), ['id', 'name'], 'settings_ai_provider', get_option('ai_provider')); ?>
</div>
...
<div class="com-md-12">
    ...
    <?php echo render_textarea('ai_system_prompt', 'settings_ai_system_prompt', get_option('ai_provider')); ?>
</div>
